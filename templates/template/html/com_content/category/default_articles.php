...
<?php if ($this->params->get('filter_field') !== 'hide' || $this->params->get('show_pagination_limit')) : ?>
	<fieldset class="com-content-category__filters filters btn-toolbar clearfix">
		...
		<!-- <button type="submit" name="filter_submit" class="btn btn-primary mx-3"><?php echo Text::_('COM_CONTENT_FORM_FILTER_SUBMIT'); ?></button> -->
...
<?php else : ?>
	...
	<table class="com-content-category__table category table table-striped table-bordered table-hover">
		...
		<?php foreach ($this->items as $i => $article) : ?>
			<?php if (J3J4::checkUnpublishedContent($this->items[$i])) : ?>
			...
			<td headers="categorylist_header_title" class="list-title">
				...
				<?php endif; ?>
				<?php if ($article->publish_down && (strtotime($article->publish_down) < strtotime(Factory::getDate())) && $article->publish_down != Factory::getDbo()->getNullDate()) : ?>
					<span class="list-published badge badge-warning">
...
<?php if (!empty($this->items)) : ?>
	<?php if (($this->params->def('show_pagination', 2) == 1  || ($this->params->get('show_pagination') == 2)) && ($this->pagination->pagesTotal > 1)) : ?>
		<div class="com-content-category__navigation w-100">
			<div class="row">
				<div class="com-content-category__pagination col-12 col-md-9">
					<?php echo $this->pagination->getPagesLinks(); ?>
				</div>

				<?php if ($this->params->def('show_pagination_results', 1)) : ?>
					<p class="com-content-category__counter counter col-12 col-md-3 pt-3 pt-md-0 text-md-right">
